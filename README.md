...
Мы команда курса java-разработчик 19.0 онлайн университета SkyPro - javaBeans, и мы представляем вашему вниманию дипломный проект: бэкенд часть платформы для перепродажи вещей.
